...
const PROTECTED =
  /^\/(dashboard|signals|context|onboarding|customer-voice|analytics|prompts|team|integrations|knowledge)(\/|$)|^\/api\/(signals|assets|context|customer-voice|analytics|prompts|team|integrations|knowledge)(\/|$)/;
